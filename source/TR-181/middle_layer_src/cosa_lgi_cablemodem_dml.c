    ...
    )
{
    ...
    if( AnscEqualString(ParamName, "CmDoc30SwRegistrationState", TRUE))
    {
        CosaDmlGiGetCmDoc30SwRegistrationState(NULL, puLong);
        return TRUE;
    }
    if( AnscEqualString(ParamName, "T1Timeouts", TRUE))
    {
    ...
    if( AnscEqualString(ParamName, "T2Timeouts", TRUE))
    {
    ...
    if( AnscEqualString(ParamName, "SoftwareOperStatus", TRUE))
    {
    ...
    if( AnscEqualString(ParamName, "OvertempProtModeState", TRUE))
    {
    ...
    if( AnscEqualString(ParamName, "EnergyMgtOperStatus", TRUE))
    {
    ...
    if( AnscEqualString(ParamName, "PartServiceFallback20", TRUE))
    {
    ...
    if( AnscEqualString(ParamName, "DownstreamPrimaryChannelID", TRUE))
    {
    ...
    )
{
    ...
    if( AnscEqualString(ParamName, "FlowSID", TRUE) )
    {
    ...
    )
{
    ...
    if( AnscEqualString(ParamName, "MaxConcatBurst", TRUE) )
    {
    ...
    if( AnscEqualString(ParamName, "SchedulingType", TRUE) )
    {
